@extends('nuky::layouts.admin') @section('title') {{ trans('nuky::googleanalytics.toplandingpages') }} @endsection @section('content')
		...
		<div class="uk-width-1-1@s">
			<div class="uk-card uk-card-default">
				...
				<div class="uk-card-body">
                    ...
                    {{ $entries->withPath('analytics-top-landing-pages')->links('nuky::admin.partials.pagination.default') }}
				</div>
			</div>
		</div>
	</div>
